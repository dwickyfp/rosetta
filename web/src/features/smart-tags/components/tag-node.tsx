...
export function TagNode({ data }: NodeProps<Node<TagNodeData>>) {
  ...
  return (
    <div className="group relative flex flex-col items-center">
      {/* Glow */}
      <div
        className="absolute rounded-full bg-indigo-500/20 blur-md"
      ...
      <div
        className={cn(
          ...
          'border-2 border-indigo-400/60 bg-indigo-600 shadow-lg shadow-indigo-500/30',
      ...
      {/* Label */}
      <span
        className="mt-1.5 max-w-[100px] truncate text-center font-medium text-indigo-200"
        style={{ fontSize }}
        title={data.label}
      >
        {data.label}
